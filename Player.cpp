...
namespace pandemic{
    ...
    Player& Player::drive(City c){
            ...
            throw invalid_argument("You can not drive this city because they are not neighbors");
        return *this;
    }
    ...
    Player& Player::fly_direct(City c){
            if(this->cards.contains(c)){
                ...
                throw invalid_argument ("You do not have the city card to fly_direct");
            }
        return *this;
    }
    ...
    Player& Player::fly_charter(City c){
            if(this->cards.contains(this->location)){
                ...
                throw invalid_argument ("You do not have the city you are standing on to use fly_charter");
            }
        return *this;
    }
    ...
    Player& Player::fly_shuttle(City c){
            if(b.research_stations.contains(this->location) && b.research_stations.contains(c) && (this->location!=c)){
                ...
                throw invalid_argument ("You can not move this city using fly_shuttle");
            }
        return *this;
    }
    ...
    Player& Player::build(){
        if(!b.research_stations.contains(this->location)){
            if(this->cards.contains(this->location)){
                ...
                throw invalid_argument ("You do not have the city card");
            }
        }
        return *this;
    }
    ...
    Player& Player::discover_cure(Color c){
            ...
            if(!b.research_stations.contains(this->location)){
                throw invalid_argument ("You have to be in a research station to discover cure");
            }
            int count =0;
            ...
            if(count >= numInColor){
                ...
                throw invalid_argument ("There is not enough cards in this color");
                }
        return *this;
    }
    ...
    Player& Player::treat(City c){
            if(this->location!=c){
                throw invalid_argument ("You should treat only in your location");
            }
            if(b.cities[c].level == 0){
                throw invalid_argument ("You can not treat when level is 0");
            }
